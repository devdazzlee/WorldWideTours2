...
<div class="bg-white  container mx-auto md:px-6">
  <section >
    ...
    <h2 style={{"color" : "#313E64"}} class="mb-6 text-3xl font-bold">Don't hesitate to <br/> contact us for more <br/> information.</h2>
    ...
    <button className="w-36 sm:w-36 md:w-36 lg:w-36 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
        Contact us
    </button>
</div>
...
<div class="mb-12 w-full shrink-0 grow-0 basis-auto md:mb-0 md:w-6/12 md:px-3 lg:px-6 part-form">
    <form class="px-4 py-4">
        ...
        <button style={{"background" : "#3B82F6"}} type="button" data-te-ripple-init data-te-ripple-color="light"
