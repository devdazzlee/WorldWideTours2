...
const DisplayCards = () => {
  ...
  return (
    <div className='flex flex-wrap justify-center bg-white cardsPosition py-6'>
      <div className="Offer-card">
      <i   style={{"color" :"#0090B7"}} class="fa-regular fa-star fa-4x"></i>
      ...
      <div className="Offer-card">
      <i  style={{"color" :"#0090B7"}} class='far fa-comments fa-4x'></i>
