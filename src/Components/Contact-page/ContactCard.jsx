...
const ContactCard = () => {
  ...
  return (
    ...
    <div style={{ boxShadow: "rgba(0, 0, 0, 0.35) 0px 5px 15px" }} className="Offer-card">
          <i  style={{"fontSize" : "2rem" , "color" : "#0391B8"}} class="fa-solid fa-location-dot"></i>
            <h1>Location</h1>
            <p>Gulshan Iqbal, Karachi</p>
          </div>
          <div style={{ boxShadow: "rgba(0, 0, 0, 0.35) 0px 5px 15px" }} className="Offer-card">

          <i   style={{"fontSize" : "2rem" , "color" : "#0391B8"}}  class="fa fa-phone " aria-hidden="true"></i>
            <h1>Call us</h1>
            <p>+92 342-3344040</p>
          </div>
          <div style={{ boxShadow: "rgba(0, 0, 0, 0.35) 0px 5px 15px" }} className="Offer-card">

          <i   style={{"fontSize" : "2rem" , "color" : "#0391B8"}}  class="fa fa-envelope " aria-hidden="true"></i>
            <h1>Our email</h1>
